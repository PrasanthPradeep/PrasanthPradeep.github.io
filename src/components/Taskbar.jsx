...
const Taskbar = ({ onCommandClick, terminalActive, activeWindows = {} }) => {
  ...
  return (
    <div 
      id="taskbar"
      className="fixed bottom-0 left-0 z-[10000] flex h-14 w-full items-center justify-between border-t border-[rgba(74,79,105,0.4)] bg-[rgba(21,22,30,0.75)] px-2 pb-2 backdrop-blur"
    >
        ...
        {taskbarIcons.map((icon) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-5 h-1 rounded-full bg-[#7aa2f7] shadow-[0_0_10px_rgba(122,162,247,0.7)]" />
              )}
            </button>
          );
        })}
